...
這是一個基於自監督學習（Self-Supervised Learning, SSL）的歌手音色提取專題。本專案基於 ISMIR 2024 論文 Singer Identity Representation Learning using Self-supervised techniques 所提出的 BYOL 架構進行改良。
